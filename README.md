...
Calculates Ramanujan-Soldner Constant to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
```bash
python "Ramanujan-Soldner Constant.py" -n 1000
```
